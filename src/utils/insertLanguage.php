...
$language_content = $_GET['language_content'];
$language_level = $_GET['language_level'];

$insert_query = "INSERT INTO language(language_content,language_level,user_id) VALUES ('$language_content','$language_level','$user_id')";
