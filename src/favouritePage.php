...
if(isset($_GET['delete_btn_submit'])){
    ...
    $delete_query = "DELETE FROM favourite_application WHERE job_ofert_id='$job_ofert_id' AND user_id=".$_SESSION['loged_user_id'];
...
<body class="main-bg overflow-x-hidden">
    ...
    <section class="w-full flex flex-col items-center">
        ...
        <div class="bg-gray-800 w-full max-w-[1400px] px-8 flex flex-col gap-5 mt-10 py-12 rounded-xl">
            <?php 
                $select_query = "SELECT * FROM favourite_application JOIN job_ofert USING (job_ofert_id) WHERE user_id=".$_SESSION['loged_user_id'];
                $connect = @new mysqli("localhost","root","","job_portal_db");
